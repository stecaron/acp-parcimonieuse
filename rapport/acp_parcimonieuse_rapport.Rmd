...
knitr::kable(data_structure_blocks, format = "latex", booktabs = T, row.names = FALSE, align = rep("c", 6), caption = "Coefficients de saturation théorique de la structure en blocks.") %>% 
  kable_styling(latex_options = c("striped", "hold_position"))
```
...
knitr::kable(data_structure_intermediaire, format = "latex", booktabs = T, row.names = FALSE, align = rep("c", 6), caption = "Coefficients de saturation théorique de la structure intermédiaire.") %>% 
  kable_styling(latex_options = c("striped", "hold_position"))
```
...
knitr::kable(data_structure_plattes, format = "latex", booktabs = T, row.names = FALSE, align = rep("c", 6), caption = "Coefficients de saturation théorique de la structure uniforme.") %>% 
  kable_styling(latex_options = c("striped", "hold_position"))
```
